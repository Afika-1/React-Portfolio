            ...
            <div className='project-content'>
                ...
                <div className='image-descr'>
                    <div className='description-icons'>
                        <div className='project-image'><a href='https://monumental-bombolone-4c47a2.netlify.app/' target='_blank'><img src={web} /></a></div>
                    ...
                    <div className='description-icons'>
                        <div className='project-image'> <a href='https://github.com/Afika-1/Chat-App' target='_blank'><img src={chat} /></a></div>
                        <div className='description'>
                    ...
                    <div className='description-icons' id='description-icons'>
                        ...
                        <div className='project-image'><a href='https://github.com/Afika-1/Tax-Calculator' target='_blank'><img src={income} /></a></div>

                    </div>

                    <div className='description-icons' id='bd'>
                        <div className='project-image'> <a href='https://github.com/Afika-1/Banking-System-App' target='_blank'><img src={simple} /></a></div>
                        <div className='description'>
